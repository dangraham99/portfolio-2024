    ...
    return (
        <span>
            {isMobileDialogOpen &&
                ...
                <div onClick={() => { setIsMobileDialogOpen(!isMobileDialogOpen) }} className="absolute top-[4.1rem] z-60 backdrop-blur-2xl mb-12 dark:bg-stone-800  bg-opacity-100 dark:bg-opacity-40  dark:border-stone-700 h-screen w-screen bg-red-500  border-stone-700">
